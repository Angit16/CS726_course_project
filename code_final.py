...
#     return tf.add(obj_loss, cord_loss), obj_loss, cord_loss, is_obj_loss, non_obj_loss, g_map, g_cord, y
    ...
    def loss_func4(model, joint_pose):
        # for i in range(400)
...
def create_optimizer(loss_func4, lr=0.001):
    opt = tf.train.GradientDescentOptimizer(lr)
    optimizer = opt.minimize(loss_func4)
    return optimizer
...
# input size is 32*32*32; x-y-z dimension limits are to be checked from the input data
    ...
    with tf.Session() as sess:
        ...
        joint_pose = np.loadtxt(r'/home/anindya/3D_CNN_tensorflow/mod_coord.txt', delimiter =',')
        ...
        for epoch in range(training_epochs):
            # for batch_x,  in batch_num, label_path=label_path:
...
if __name__ == '__main__':
     ...
     label_path = "/home/anindya/3D_CNN_tensorflow/mod_coord.txt" # joint pose
    ...
    # label_path = "/home/katou01/download/testing/calib/002397.txt"
